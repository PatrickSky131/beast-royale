...
// 实现Response接口
func (br *BaseResponse) GetAction() string {
	return br.Action
}

func (br *BaseResponse) GetRequestUUID() string {
	return br.RequestUUID
}

func (br *BaseResponse) GetRetCode() int {
	return br.RetCode
}

func (br *BaseResponse) GetMessage() string {
	return br.Message
}

func MakeErrorResponse(retCode int, message string) *BaseResponse {
	return &BaseResponse{
		RetCode: retCode,
		Message: message,
	}
